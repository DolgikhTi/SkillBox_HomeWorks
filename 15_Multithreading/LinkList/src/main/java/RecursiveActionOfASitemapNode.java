...
public class RecursiveActionOfASitemapNode extends RecursiveAction {

    private SitemapNode node;

    public RecursiveActionOfASitemapNode(SitemapNode node) {
        this.node = node;
    }
    ...
    protected void compute() {
        ...
        for (SitemapNode child : node.getChildren()) {
            RecursiveActionOfASitemapNode task = new RecursiveActionOfASitemapNode(child);
            task.compute();
        }
    }
